    ...
    while True:
        ...
        match interface_num:
            case "1":
                try:
                    social_network = input(
                        "Введите социальную сеть, которую использует наш пользователь:")
            ...
            case "2":
                try:
                    id_user = int(
                        input("Укажите id пользователя, которому вы хотите что-либо обновить: "))
                    choose_update = input(
                        "Укажите, что вы хотите обновить: 1 - Имя, 2 - Фамилию, 3 - Имя и Фамилию: ")
                    if choose_update == 1:
            ...
            case "3":
                try:
                    id_user = int(
                        input("Укажите id пользователя, информацию о котором вы хотите удалить: "))
                    ds.delete(id_user)
                except ValueError:
                    print("ID должно быть целым числом.")
                except InvalidIdUserException as err:
            ...
            case "5":
                try:
                    id_user = int(
                        input("Укажите id пользователя, информацию о котором вы хотите узнать: "))
            ...
            case "6":
                try:
                    filename = input(
                        "Укажите название файла, в который вы хотите сохранить информацию о пользователях (например name.json):")
                    ds.to_json(filename)
            ...
            case "7":
                try:
                    filename = input(
                        "Укажите название файла, из которого вы хотите выгрузить информацию о пользователях (например name.json):")
            ...
            case "8":
                try:
                    filename = input(
                        "Укажите название файла, в который вы хотите сохранить информацию о пользователях (например name.xml):")
                    ds.to_xml(filename)
                except InvalidTypeFileException as err:
                    print(f"Error: {err}")
            case "9":
                try:
                    filename = input(
                        "Укажите название файла, из которого вы хотите выгрузить информацию о пользователях (например name.xml):")
